...
class SocialMediaGroupsService {
  Future<Either<List<SocialMediaGroup>, String>> getSocialGroups() async {
    ...
    String getSocialGroupsUrl =
        defaultApi('social-groups', Get.locale!.languageCode);
      ...
      switch (response.statusCode) {
        case 200:
          return left(List.generate(responseArray["data"].length,
              (index) => SocialMediaGroup.fromJson(responseArray["data"][index])));
        case 422:
          return right(
